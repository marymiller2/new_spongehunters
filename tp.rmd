---
title: _Trochospongilla pennsylvanica_
...
_T. pennsylvanica_ has been found in this study. Please stay tuned for more information of this organism!

<br>

<center>
![](Tp_on_substrate.jpg){width=75%}
</center>

<br>

<center>
![](Tp_spicules.jpg){width=75%}
</center>

<br>

<center>
![](Tp_SEM_1.jpg){width=75%}
</center>
<center>
![](Tp_SEM_2.jpg){width=75%}
</center>
...
sites<-read_xlsx("map_data_files/GPS Coordinates - Sites and Species UPDATED 3_12_24.xlsx", sheet="Tp")
```

```{r map, echo=FALSE, fig.align='center', fig.asp=.95}
(map1<-ggplot()+
    geom_sf(data=la.c)+
    geom_point(aes(x=Long,y=Lat, color=Tp),data=sites,size=3)+
