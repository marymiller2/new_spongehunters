...
_E. fragilis_ has been found in this study. Please stay tuned for more information of this organism!

<br>

<center>
![](Euf_on_substrate.JPG){width=75%}
</center>

<br>

<center>
![](Euf_spicules.JPG){width=75%}
</center>

<br>

<center>
![](Euf_SEM_1.JPG){width=75%}
</center>
<center>
![](Euf_SEM_2.JPG){width=75%}
</center>
<center>
![](Euf_SEM_3.JPG){width=75%}
</center>
<center>
![](Euf_SEM_4.JPG){width=75%}
</center>
...
sites<-read_xlsx("map_data_files/GPS Coordinates - Sites and Species UPDATED 3_12_24.xlsx", sheet="Efr")
```
...
(map1<-ggplot()+
    ...
    scale_color_brewer(palette = "Dark2",name="Eunapius fragilis")+
    ylab("Latitude")+
    xlab("Longitude")+
    theme_set(theme_bw())+ 
