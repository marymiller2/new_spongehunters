...
Currently, we have surveyed over 200 sites! The site map below is continuously updated with the sites surveyed in this study. Sites are further labeled with the observation of sponge presence or absence.
...
(map2<-map2+
    ...
    scale_color_brewer(palette = "Set1",name="Sites")+
    ylab("Latitude")+
    xlab("Longitude")+
